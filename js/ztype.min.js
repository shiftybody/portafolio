...
ig.module("game.menus.base")
  ...
  .defines(function () {
    ...
    Menu = ig.Class.extend({
      clearColor: null,
      name: null,
      font: new ig.Font("../../assets/media/fonts/avenir-36-white.png"),
      fontSelected: new ig.Font("../../assets/media/fonts/avenir-36-orange.png"),
      current: 0,
      itemClasses: [],
      items: [],
      scale: 1,
...
ig.module("game.menus.about")
  ...
  .defines(function () {
    ...
    MenuAbout = Menu.extend({
      background: new ig.Image("../../assets/media/background/stars.jpg"),
      credits: new ig.Image("../../assets/media/title/credits.png"),
      scale: 0.75,
      scroll: 0,
...
ig.module("game.menus.interstitial")
  ...
  .defines(function () {
    ...
    MenuInterstitial = Menu.extend({
      ...
      scale: 0.75,
      banner: new ig.Image("../../assets/media/nfn-phoboslab-works.png"),
      init: function () {
        this.parent();
    ...
    StatsView = ig.Class.extend({
      ...
      receivedData: function (response) {
        ...
        for (var i = 0; i < this.data.length; i++) {
          ...
          this.maxPUNTAJE = Math.max(this.maxPUNTAJE, d.PUNTAJE);
        }
        this.isExcerpt = response.isExcerpt;
        this.totalGames = response.totalGames;
        this.PUNTAJEScale = this.roundToMagnitude(this.maxPUNTAJE);
        this.timer.reset();
      },
      ...
      drawGraph: function (x, y) {
        ...
        for (var i = 0; i < numLabels; i++) {
          ...
          var label = Math.round(v * this.PUNTAJEScale);
          var xp = x + this.width,
        ...
        for (var i = 0; i < max; i++) {
          ...
          var rx = x + (rw - 3) * v,
            ry =
              y + this.height - (this.height - 3) * (d.PUNTAJE / this.PUNTAJEScale);
...
ig.module("game.menus.game-over")
  ...
  .defines(function () {
    ...
    MenuGameOver = Menu.extend({
      ...
      scale: 0.75,
      personalBestBadge: new ig.Image("../../assets/media/ui/personal-best-badge.png"),
      fontTitle: new ig.Font("../../assets/media/fonts/avenir-36-blue.png"),
      separatorBar: new ig.Image("../../assets/media/ui/bar-blue.png"),
      init: function () {
        if (ig.doc) {
        ...
        this.stats.submit({
          PUNTAJE: ig.game.PUNTAJE,
          OLEADA: ig.game.OLEADA.OLEADA,
          // streak: ig.game.longestStreak,
          EXACTITUD: ig.game.hits
      ...
      draw: function () {
        ...
        ctx.scale(ss, ss);
        ctx.globalAlpha = 0.5;
        this.font.draw("PUNTAJE", 24 / ss, (ys + 0) / ss);
        this.font.draw("LLEGASTE A LA", 252 / ss, (ys + 0) / ss);
        this.font.draw("EXACTITUD", 24 / ss, (ys + 140) / ss);
        // this.font.draw("LONGEST STREAK", 252 / ss, (ys + 140) / ss);
        ctx.restore();
        this.fontTitle.draw(ig.game.PUNTAJE.zeroFill(6), 24, ys + 25);
        this.fontTitle.draw(
          "OLEADA " + ig.game.OLEADA.OLEADA.zeroFill(3),
          252,
          ys + 25
        );
        ig.system.context.drawImage(
    ...
    DetailedStats = ig.Class.extend({
      ...
      _initChart: function (response) {
        ...
        for (var i = 0; i < response.games.length; i++) {
          ...
          this.maxPUNTAJE = Math.max(this.maxPUNTAJE, g.PUNTAJE);
        }
        this.PUNTAJEScale = this.roundToMagnitude(this.maxPUNTAJE);
        this.timer = new ig.Timer();
        this.data = response.games;
      ...
      drawOnCanvas: function (canvas, mx, my) {
        ...
        ctx.fillStyle = "#ccc";
        ctx.fillText("PUNTAJES OVER " + this.data.length + " GAMES", 140, 38);
        ...
        for (var i = 0; i < this.data.length; i++) {
          ...
          var v = (1 / (this.data.length - 1)) * i || 0;
          var rx = x + (rw - 3) * v,
            ry = y + height - (height - 3) * (g.PUNTAJE / this.PUNTAJEScale);
          ctx.fillRect(rx, ry, 3, 3);
          if (lastp) {
            ctx.beginPath();
            ctx.moveTo(lastp.x + 1.5, lastp.y + 1.5);
        ...
        if (plot) {
          ...
          var scdesc = "PUNTAJE " + plot.game.PUNTAJE;
          ctx.fillStyle = "#555";
      ...
      savePUNTAJEsScreenshot: function (callback) {
      ...
      shareFacebook: function () {
        ...
        this.savePUNTAJEsScreenshot(function (response) {
          ...
          shareWindow.location.href =
            ...
            "&display=popup" +
            "&caption=" +
            encodeURIComponent("My ZTYPE PUNTAJEs") +
            "&link=" +
      ...
      shareTwitter: function () {
        ...
        this.savePUNTAJEsScreenshot(function (response) {
          ...
          shareWindow.location.href =
            ...
            "?text=" +
            encodeURIComponent("My #ZTYPE PUNTAJEs: " + imageUrl + " - ");
        });
      },
    });
  });
...
ig.module("game.menus.title")
  ...
  .defines(function () {
    ...
    MenuItemGameCenter = MenuItem.extend({
      ...
      ok: function () {
        ig.game.gameCenter.showLeaderboard("PUNTAJE");
      },
    });
    ...
    MenuTitle = Menu.extend({
      ...
      scroll: 0,
      background: new ig.Image("../../assets/media/background/stars.jpg"),
      ztype: new ig.Image("../../assets/media/title/ztype.png"),
      phoboslab: new ig.Image("../../assets/media/title/phoboslab.png"),
      ship: new ig.Image("../../assets/media/title/ship.png"),
      exhaust: new ig.Image("../../assets/media/title/exhaust.png"),
      infoIcon: new ig.Image("../../assets/media/ui/information.png"),
      glitchStripe: new ig.Image("../../assets/media/title/glitch-stripe.png"),
      glitchCode: new ig.Image("../../assets/media/title/glitch-code.png"),
      glitchJPEG: new ig.Image("../../assets/media/title/glitch-jpeg.png"),
      glitchGraph: new ig.Image("../../assets/media/title/glitch-graph.png"),
      glitchLog: new ig.Image("../../assets/media/title/glitch-log.png"),
...
ig.module("game.entities.explosion")
  ...
  .defines(function () {
    window.EntityExplosionParticle = EntityParticle.extend({
      ...
      fadetime: 0.5,
      vel: { x: 60, y: 60 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/explosion.png", 32, 32),
      init: function (x, y, settings) {
    ...
    window.EntityExplosionSpark = EntityParticle.extend({
      ...
      fadetime: 0.5,
      vel: { x: 60, y: 60 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/spark.png", 48, 48),
      init: function (x, y, settings) {
    ...
    window.EntityExplosionHuge = ig.Entity.extend({
      ...
      fadetime: 1,
      alpha: 0,
      img: new ig.Image("../../assets/media/sprites/explosion-huge.jpg", 512, 512),
      init: function (x, y, settings) {
        this.parent(x, y, settings);
        this.idleTimer = new ig.Timer();
      },
    ...
    window.EntityExplosionHugeGlitch = EntityExplosionHuge.extend({
      img: new ig.Image("../../assets/media/sprites/explosion-huge-glitch.jpg", 512, 512),
      glitchJPEG: new ig.Image("../../assets/media/title/glitch-jpeg.png"),
      glitchStripe: new ig.Image("../../assets/media/title/glitch-stripe.png"),
      draw: function () {
        this.parent();
...
ig.module("game.entities.enemy")
  ...
  .defines(function () {
    EntityEnemy = ig.Entity.extend({
      ...
      currentLetter: 0,
      targeted: false,
      font: new ig.FontAvenirNext("../../assets/media/fonts/avenir-22-white-v2.png"),
      fontActive: new ig.FontAvenirNext("../../assets/media/fonts/avenir-22-orange-v2.png"),
      speed: 10,
      ...
      numKillParticles: 20,
      numHitParticles: 5,
      soundHit: new ig.Sound("../../assets/media/sounds/hit.ogg"),
      soundTarget: new ig.Sound("../../assets/media/sounds/target.ogg"),
      reticleTimer: null,
      reticle: new ig.Image("../../assets/media/ui/reticle.png"),
...
ig.module("game.entities.enemy-missle")
  ...
  .defines(function () {
    EntityEnemyMissle = EntityEnemy.extend({
      size: { x: 8, y: 15 },
      offset: { x: 6, y: 7 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/missle.png", 20, 26),
      explosionSound: new ig.Sound("../../assets/media/sounds/explosion-small.ogg"),
      health: 4,
      speed: 35,
      targetTimer: null,
...
ig.module("game.entities.enemy-mine")
  ...
  .defines(function () {
    EntityEnemyMine = EntityEnemy.extend({
      size: { x: 12, y: 12 },
      offset: { x: 10, y: 10 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/mine.png", 32, 32),
      explosionSound: new ig.Sound("../../assets/media/sounds/explosion.ogg"),
      speed: 30,
      health: 6,
...
ig.module("game.entities.enemy-destroyer")
  ...
  .defines(function () {
    EntityEnemyDestroyer = EntityEnemy.extend({
      size: { x: 24, y: 34 },
      offset: { x: 10, y: 8 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/destroyer.png", 43, 58),
      explosionSound: new ig.Sound("../../assets/media/sounds/explosion-large.ogg"),
      health: 8,
      speed: 20,
      shootTimer: null,
...
ig.module("game.entities.enemy-oppressor")
  ...
  .defines(function () {
    EntityEnemyOppressor = EntityEnemy.extend({
      size: { x: 36, y: 58 },
      offset: { x: 16, y: 10 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/oppressor.png", 68, 88),
      explosionSound: new ig.Sound("../../assets/media/sounds/explosion-large.ogg"),
      health: 10,
      speed: 15,
      shootTimer: null,
    ...
    EntityEnemyBullet = EntityEnemy.extend({
      size: { x: 2, y: 2 },
      offset: { x: 8, y: 11 },
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/bullet.png", 20, 24),
      health: 1,
      speed: 50,
...
ig.module("game.entities.emp")
  ...
  .defines(function () {
    ...
    window.EntityEMP = ig.Entity.extend({
      ...
      img: new ig.Image("../../assets/media/sprites/emp.png"),
      sound: new ig.Sound("../../assets/media/sounds/emp.ogg", false),
      init: function (x, y, settings) {
        this.parent(x, y, settings);
        this.idleTimer = new ig.Timer();
        this.sound.play();
...
ig.module("game.entities.player")
  ...
  .defines(function () {
    EntityPlayer = ig.Entity.extend({
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/ship.png", 24, 24),
      targetAngle: 0,
      size: { x: 8, y: 8 },
      offset: { x: 8, y: 8 },
      angle: 0,
      targetAngle: 0,
      soundShoot: new ig.Sound("../../assets/media/sounds/plasma.ogg"),
      soundMiss: new ig.Sound("../../assets/media/sounds/click.ogg"),
      soundExplode: new ig.Sound("../../assets/media/sounds/explosion-player.ogg"),
    ...
    EntityPlasma = ig.Entity.extend({
      ...
      animSheet: new ig.AnimationSheet("../../assets/media/sprites/plasma.png", 96, 96),
      size: { x: 4, y: 4 },
      offset: { x: 46, y: 46 },
      distance: 100000,
      init: function (x, y, settings) {
...
ig.module("game.keyboard")
  ...
  .defines(function () {
    ig.Keyboard = ig.Class.extend({
      background: new ig.Image("../../assets/media/ui/keyboard-background.png"),
      keyboard: null,
      empButton: new ig.Image("../../assets/media/ui/emp-buttons.png"),
      pauseButton: new ig.Image("../../assets/media/ui/pause.png"),
      font: new ig.Font("../../assets/media/fonts/avenir-36-blue.png"),
      hoverImages: {
        leftEdge: new ig.Image("../../assets/media/ui/key-edge-left.png"),
        rightEdge: new ig.Image("../../assets/media/ui/key-edge-right.png"),
        normal: new ig.Image("../../assets/media/ui/key.png"),
      },
      multiBar: new ig.Image("../../assets/media/ui/bar-blue.png"),
      multiIndicator: new ig.Image("../../assets/media/ui/multi-indicator.png"),
      multiSounds: {
        2: new ig.Sound("../../assets/media/sounds/multi-2.ogg"),
        3: new ig.Sound("../../assets/media/sounds/multi-3.ogg"),
      },
      width: 0,
      height: 0,
      hoverKey: null,
...
ig.module("game.main")
  ...
  .defines(function () {
    ...
    ZType = ig.Game.extend({
      font: new ig.Font("../../assets/media/fonts/avenir-18-white.png"),
      fontTitle: new ig.Font("../../assets/media/fonts/avenir-36-blue.png"),
      separatorBar: new ig.Image("../../assets/media/ui/bar-blue.png"),
      idleTimer: null,
      spawnTimer: null,
      ...
      yScroll: 0,
      yScroll2: 0,
      gradient: new ig.Image("../../assets/media/background/gradient.png"),
      stars: new ig.Image("../../assets/media/background/stars.jpg"),
      grid: new ig.Image("../../assets/media/background/grid.png"),
      music1: new ig.Sound("../../assets/media/music/endure.ogg", false),
      music2: new ig.Sound("../../assets/media/music/orientation.ogg", false),
      cancelSound: new ig.Sound("../../assets/media/sounds/cancel.ogg"),
      spawnSound: new ig.Sound("../../assets/media/sounds/spawn.ogg"),
      menu: null,
      mode: 0,
      PUNTAJE: 0,
      streak: 0,
      ...
      init: function () {
        ...
        this.personalBest = parseInt(ig.storageGet("highPUNTAJE")) | 0;
        if (window.Ejecta) {
      ...
      reset: function () {
        ...
        this.bufferedLetters = [];
        this.OLEADA = ig.copy(ZType.OLEADAS[this.difficulty]);
        this.PUNTAJE = 0;
        this.rs = 0;
        this.streak = 0;
        ...
        this.idleTimer = new ig.Timer();
        this.OLEADAEndTimer = null;
      },
      nextOLEADA: function () {
        this.OLEADA.OLEADA++;
        this.OLEADA.spawnWait = (this.OLEADA.spawnWait * 0.97).limit(0.2, 1);
        this.OLEADA.currentSpawnWait = this.OLEADA.spawnWait;
        this.OLEADA.spawn = [];
        this.speedFactor *= this.OLEADA.speedIncrease;
        if (ig.doc) {
          for (var i = 0; i < 10 && this.OLEADA.spawn.length < 2; i++) {
            this.nextDocFragment();
          }
          this.OLEADA.spawn.reverse();
        } else {
          var dec = 0;
          for (var t = 0; t < this.OLEADA.types.length; t++) {
            var type = this.OLEADA.types[t];
            type.count -= dec;
            if (this.OLEADA.OLEADA % type.incEvery == 0) {
              type.count++;
              dec++;
            }
            for (var s = 0; s < type.count; s++) {
              this.OLEADA.spawn.push(type);
            }
          }
          this.OLEADA.spawn.sort(function () {
            return Math.random() - 0.5;
          });
        }
      },
      nextDocFragment: function () {
        this.OLEADA.fragment++;
        var fragment =
          ig.doc.fragments[(this.OLEADA.fragment - 1) % ig.doc.fragments.length];
        if (!ig.ua.mobile) {
        ...
        var bigShipChance =
          (this.OLEADA.types[0].count + this.OLEADA.types[1].count) /
          this.OLEADA.types[2].count;
        ...
        for (var i = 0; i < filteredWords.length; i++) {
          ...
          var type =
            w.length > wordLengthForBigShip
              ...
              : EntityEnemyMine;
          this.OLEADA.spawn.push({ type: type, word: w, wait: wait });
        }
      },
      spawnCurrentOLEADA: function () {
        if (!this.OLEADA.spawn.length) {
          if (this.entities.length <= 1 && !this.OLEADAEndTimer) {
            this.OLEADAEndTimer = new ig.Timer(2);
          } else if (this.OLEADAEndTimer && this.OLEADAEndTimer.delta() > 0) {
            this.OLEADAEndTimer = null;
            this.nextOLEADA();
          }
        } else if (this.spawnTimer.delta() > this.OLEADA.currentSpawnWait) {
          this.spawnTimer.reset();
          var spawn = this.OLEADA.spawn.pop();
          ...
          this.spawnEntity(
            ...
            x,
            y,
            { healthBoost: this.OLEADA.healthBoost, word: spawn.word },
            true
          );
          this.OLEADA.currentSpawnWait = spawn.wait
            ? this.OLEADA.spawnWait * spawn.wait
            : this.OLEADA.spawnWait;
        }
      },
      ...
      continue: function () {
        var fragment = this.OLEADA.fragment;
        this.setGameState();
        this.OLEADA.fragment = Math.max(0, fragment - 1);
        this.nextOLEADA();
        this.menu = null;
      },
      setGameOver: function () {
        if (this.PUNTAJE > this.personalBest) {
          this.isPersonalBest = true;
          this.personalBest = this.PUNTAJE;
          ig.storageSet("PUNTAJE", this.personalBest);
        }
        if (this.gameCenter && this.PUNTAJE > 5) {
          this.gameCenter.reportPUNTAJE("PUNTAJE", this.PUNTAJE);
        }
      ...
      update: function () {
        ...
        var scrollSpeed = 100;
        if (this.OLEADAEndTimer) {
          this.player.targetAngle = 0;
          var dt = Math.sin(this.OLEADAEndTimer.delta() * -0.5 * Math.PI);
        ...
        if (this.PUNTAJE - this.rs > 100 || ig.Timer.timeScale != 1) {
          this.PUNTAJE = 0;
        }
        this.rs = this.PUNTAJE;
      ...
      drawUI: function () {
        if (this.OLEADAEndTimer) {
          ...
          this.font.draw(
            "PUNTAJE: " + this.PUNTAJE.zeroFill(6),
            32,
            ys * 1.2 + 10,
            ig.Font.ALIGN.LEFT
          );
        ...
        if (!ig.ua.mobile && this.idleTimer.delta() > 8) {
          ...
          this.font.draw(
            "Teclea para disparar!\nENTER para gastar una vida",
            ig.system.width / 2,
